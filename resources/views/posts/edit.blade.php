    ...
    <div class="container-fluid px-0">
        ...
        <div class="content">
            ...
            <form action="/posts/{{ $post->id }}/update" enctype="multipart/form-data" method="post">
                ...
                <div class="mb-3"><label class="form-label" for="exampleTextarea">Post Text</label> <textarea name="body" style="min-height: 400px;" class="form-control needs-validation" id="exampleTextarea" rows="3">{{ $post->body }}</textarea></div>
