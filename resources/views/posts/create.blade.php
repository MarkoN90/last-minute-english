    ...
    <div class="container-fluid px-0">
        ...
        <div class="content">
            ...
            <form action="/posts" enctype="multipart/form-data" method="post">
                @csrf
                <div class="mb-3"><label class="form-label" for="exampleFormControlInput1">Post Title</label> <input class="form-control" id="exampleFormControlInput1" name="title"   placeholder=""></div>

                <div class="mb-3"><label class="form-label" for="customFile">Post Image</label> <input name="image" class="form-control" id="customFile" type="file"></div>
